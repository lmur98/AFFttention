...
_C.OUTPUT_DIR = "/home/lmur/stillfast_baseline/stillfast/output"
_C.NUM_SHARDS = 1
_C.SAVE_TOP_K = 1
...
# Optimization method.
_C.SOLVER.OPTIMIZING_METHOD = "adam" #"sgd"
...
_C.MODEL.STILL.BACKBONE.EMBEDDING_SIZE = 384
_C.MODEL.STILL.BACKBONE.LAST_LAYER = 11
_C.MODEL.STILL.PRETRAINED = True
_C.MODEL.STILL.REPLACE_HEAD = True

_C.MODEL.DETR_NUM_QUERIES = 100
_C.MODEL.DETR_NUM_CHANNELS = 768
...
_C.MODEL.STILLFAST.ROI_HEADS.VERSION = 'v2' #v2
...
#NEWW
_C.MODEL.PATCH_SIZE = None
_C.MODEL.DINO_LAST_LAYERS = [11]
_C.DATA.STILL.SIZE_DIVISIBLE = 14
