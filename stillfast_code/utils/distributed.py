...
# From https://raw.githubusercontent.com/EGO4D/forecasting/main/ego4d/utils/distributed.py
...
#import logging
import sys
sys.path.append('/home/lmur/stillfast_baseline/stillfast/stillfast')
import logging_stillfast as logging
import os
import pickle
import itertools
...
def list_gather(data, group=None):
    return list(itertools.chain(*all_gather_unaligned(data, group)))
