    ...
    if cfg.SOLVER.OPTIMIZING_METHOD == "sgd":
        ...
        for name, p in model.named_parameters():
            if "backbone" in name:
                ...
                non_bn_parameters.append(p)
        param_dict = [{'params': backbone_params, 'lr': cfg.SOLVER.BASE_LR * 0.1},
                      {'params': non_backbone_parameters, 'lr': cfg.SOLVER.BASE_LR}]
                
        return torch.optim.AdamW(param_dict, weight_decay = cfg.SOLVER.WEIGHT_DECAY) 
    else:
